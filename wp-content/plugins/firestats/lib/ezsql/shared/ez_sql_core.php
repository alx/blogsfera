<?php
	...
	*/
	...
	define('FS_EZSQL_VERSION','2.03-firestats');
	...
	*/
	...
	class fs_ezSQLcore
	{
		...
		*/
		...
		/**********************************************************************
		*  Disconnect from DB - over-ridden by specific DB class
		*/
		...
		*/
		...
		function vardump($mixed='')
		{
			...
			{
				echo "<font color=800080><b>ezSQL</b> (v".FS_EZSQL_VERSION.") <b>Variable Dump..</b></font>\n\n";
			}
		...
		*/
		...
		function debug($override_echo = null)
		{
			...
			{
				echo "<font color=800080 face=arial size=2><b>ezSQL</b> (v".FS_EZSQL_VERSION.") <b>Debug..</b></font><p>\n";
			}
			...
			// Only echo output if it is turned on
			$echo = $this->debug_echo_is_on;
			if (is_bool($override_echo)) $echo = $override_echo;
			if ( $echo )
			{
				echo $html;
			}
		...
		*/
		...
		function donation()
		{
			// soryy, at this stage the last thing my users want is to donate
			/*
